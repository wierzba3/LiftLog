...
public class DataLoader
{
    ...
    public static void reload(Context ctx)
    {
		...
		dao.insert(createLift(sessionId, SUMO_DL_DOH_BL_ID, 315, 6, 3));
		dao.insert(createLift(sessionId, CHINUPS_ID, 235, 5, 3));
		dao.insert(createLift(sessionId, HAMSTRING_CURLS_ID, 80, 12, 3));
		...
		dao.insert(createLift(sessionId, SUMO_DL_DOH_BL_ID, 315, 8, 3));
		dao.insert(createLift(sessionId, CHINUPS_ID, 235, 7, 3));
		dao.insert(createLift(sessionId, HAMSTRING_CURLS_ID, 80, 13, 3));
		...
		dao.insert(createLift(sessionId, SUMO_DL_DOH_BL_ID, 325, 6, 3));
		dao.insert(createLift(sessionId, CHINUPS_ID, 235, 8, 4));
		dao.insert(createLift(sessionId, HAMSTRING_CURLS_ID, 80, 15, 3));
		...
		dao.insert(createLift(sessionId, SUMO_DL_DOH_BL_ID, 335, 5, 4));
		dao.insert(createLift(sessionId, CHINUPS_ID, 240, 8, 3));
		dao.insert(createLift(sessionId, HAMSTRING_CURLS_ID, 95, 10, 3));
		...
		dao.insert(createLift(sessionId, SUMO_DL_DOH_BL_ID, 335, 6, 3));
		dao.insert(createLift(sessionId, CHINUPS_ID, 245, 6, 3));
		dao.insert(createLift(sessionId, HAMSTRING_CURLS_ID, 65, 12, 3));
		...
		dao.insert(createLift(sessionId, SUMO_DL_DOH_BL_ID, 335, 8, 3));
		dao.insert(createLift(sessionId, CHINUPS_ID, 245, 8, 3));
		dao.insert(createLift(sessionId, HAMSTRING_CURLS_ID, 65, 14, 3));
		...
		dao.insert(createLift(sessionId, SUMO_DL_DOH_BL_ID, 340, 8, 3));
		...
		dao.insert(createLift(sessionId, SUMO_DL_DOH_BL_ID, 345, 8, 3));
		...
		dao.insert(createLift(sessionId, SUMO_DL_DOH_BL_ID, 350, 6, 3));
		dao.insert(createLift(sessionId, CHINUPS_ID, 250, 8, 3));
		...
		dao.insert(createLift(sessionId, BENCH_P_ID, 275, 1, 3));
		dao.insert(createLift(sessionId, BB_ROW_ID, 132, 12, 3));
